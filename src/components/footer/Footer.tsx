    ...
    <div className="w-full max-w-screen-xl p-4 mx-auto md:py-8">
        <div className="sm:flex sm:items-center sm:justify-between">
            ...
            <ul className="flex flex-wrap items-center mb-6 text-sm font-medium text-gray-500 sm:mb-0 dark:text-gray-400">
                ...
                <li>
                    <a href="#" className="hover:underline me-4 md:me-6">Privacidade</a>
                </li>
                <li>
        ...
        <span className="block text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 <a className="hover:underline">Dlogalia</a>. Todos os direitos para o cebolinha.</span>
    </div>
</footer>
